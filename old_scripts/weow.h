...
// Mon Dec  2 16:29:11 2024 by ROOT version 6.26/10
// from TTree evt//cbmout_0
// found on file: 162Eu_0043_0013.root
//////////////////////////////////////////////////////////
...
public :
   ...
   TTreeReaderValue<unsigned int> EventHeader_fEventno = {fReader, "EventHeader.fEventno"};
   TTreeReaderValue<unsigned int> EventHeader_fTrigger = {fReader, "EventHeader.fTrigger"};
   TTreeReaderValue<unsigned int> EventHeader_fTimeStamp = {fReader, "EventHeader.fTimeStamp"};
   TTreeReaderValue<unsigned int> EventHeader_fSpillFlag = {fReader, "EventHeader.fSpillFlag"};
